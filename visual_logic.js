 ...
 * Wed Apr 03 2024 19:03:03 GMT+0530 (India Standard Time)
...
function drag(x) {
  registerOnDrag(x, false, [0,1,2], function() {}, function() {
    dragMove(x, 'XYZ', 'H,A=0TD9-*$uL%-^aY|=', '%9@x~[(l6%Rr8k4aO-L6');
  }, function() {}, '%9@x~[(l6%Rr8k4aO-L6');
}
...
eventHTMLElem('click', 'red', false, function(event) {
  r = cloneObject('Cube.001');
  setObjTransform(r, false, 'position', [-8, 50, 2], false);
  changeVis('Cube.001', true);
  drag(r);
});
registerOnDrag('Cube.001', false, [0,1,2], function() {}, function() {
  dragMove('Cube.001', 'XYZ', 'AaY0+(S2dU}CcUP#X)qx', '^1UUUQ;@7q)2b1f.wbaA');
}, function() {}, '^1UUUQ;@7q)2b1f.wbaA');
...
eventHTMLElem('click', 'blue', false, function(event) {
  b = cloneObject('Cube');
  setObjTransform(b, false, 'position', [1, 40, 2], false);
  changeVis('Cube', true);
  drag(b);
});
registerOnDrag('Cube', false, [0,1,2], function() {}, function() {
  dragMove('Cube', 'XYZ', 'voX0!a[T4Gc-do+!U-dP', '_j6a]A_N[/:EuOxD#?2o');
}, function() {}, '_j6a]A_N[/:EuOxD#?2o');
...
eventHTMLElem('click', 'yellow', false, function(event) {
  y = cloneObject('Cylinder');
  setObjTransform(y, false, 'position', [0, 47, 3.5], false);
  changeVis('Cylinder', true);
  drag(y);
});
registerOnDrag('Cylinder', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder', 'XYZ', '`8`Ei.gUe3ZIj|/Q2JFK', '@**uULHp!Axdzs(sa?wt');
}, function() {}, '@**uULHp!Axdzs(sa?wt');
